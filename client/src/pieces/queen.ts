      ...
      if (temp5 - 9 > -1) {
        if (temp5 % 8 === 0) {
          ...
          if (squares[temp5 - 9] === null) {
            ...
            squares[temp5 - 9] !== null &&
            squares[temp5 - 9].player === 1 &&
      ...
      if (temp6 - 7 > -1) {
        if ((temp6 + 1) % 8 === 0) {
          ...
          if (squares[temp6 - 7] === null) {
            ...
            squares[temp6 - 7] !== null &&
            squares[temp6 - 7].player === 1 &&
            squares[src].player === 2
          ) {
            highLightMoves.push(temp6 - 7);
            temp6 = temp6 - 7;
      ...
      if (temp7 + 7 < 64) {
        if (temp7 % 8 === 0) {
          ...
          if (squares[temp7 + 7] === null) {
            ...
            squares[temp7 + 7] !== null &&
            squares[temp7 + 7].player === 1 &&
            squares[src].player === 2
          ) {
            highLightMoves.push(temp7 + 7);
            temp7 = temp7 + 7;
      ...
      if (temp8 + 9 < 64) {
        if ((temp8 + 1) % 8 === 0) {
          ...
          if (squares[temp8 + 9] === null) {
            ...
            squares[temp8 + 9] !== null &&
            squares[temp8 + 9].player === 1 &&
            squares[src].player === 2
          ) {
            highLightMoves.push(temp8 + 9);
            temp8 = temp8 + 9;
