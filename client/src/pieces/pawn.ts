  ...
  possibleMoves(
    ...
    if (this.player === 1 && (src - 7 > 0 || src - 9 > 0)) {
      if (
        squares[src - 8] === null &&
        squares[src - 16] === null &&
        this.initialPositions[this.player].indexOf(src) !== -1
      ) {
      ...
      if (
        ...
        squares[src - 1] !== null &&
        src % 8 !== 0 &&
        squares[src - 1].player === 2 &&
        src - 1 === lastTurnPawnPosition
      ) {
        highLightMoves.push(src - 9);
      }
      if (
